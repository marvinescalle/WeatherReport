  ...
  <div class="main">
    ...
    <div v-else class="weather" :class="{ day: isDay, night: isNight }">
      ...
      <div class="weather-wrap">
        ...
        <!-- <theWeeklyForecast :forecast="forecast" /> -->
        <!-- <theAdditionalInfo :currentWeather="currentWeather" /> -->
      </div>
    </div>
  </div>
</template>
...
import theCurrentWeather from "../components/theCurrentWeather"
import theHourlyWeather from "../components/theHourlyWeather"

export default {
  name:  "theWeather",
  // Propriétées utilisées
...
beforeDestroy() {
  ...
  methods: {
    ...
    // Récupère l'heure actuelle pour dire s'il fait jour ou nuit
    getCurrentTime() {
